...
function App() {
  ...
  const rawInteractionsData = [
    ...
    { mes: 'feb', usuario: ' Yeny González', interacciones: 7 },
    { mes: 'feb', usuario: ' Jhon González', interacciones: 5 },
    { mes: 'feb', usuario: ' MP', interacciones: 4 },
    { mes: 'feb', usuario: ' Laura Plazas', interacciones: 4 },
    ...
    { mes: 'feb', usuario: ' Camilo Parada', interacciones: 1 },
    ...
    { mes: 'mar', usuario: ' Laura Plazas', interacciones: 46 },
    { mes: 'mar', usuario: ' AdriRomero', interacciones: 38 },
    { mes: 'mar', usuario: ' Camilo Parada', interacciones: 38 },
    ...
    { mes: 'mar', usuario: ' Yeny González', interacciones: 28 },
    ...
    { mes: 'abr', usuario: ' Camilo Parada', interacciones: 51 },
    { mes: 'abr', usuario: ' Laura Plazas', interacciones: 50 },
    ...
    { mes: 'abr', usuario: ' Yeny González', interacciones: 32 },
    ...
    { mes: 'abr', usuario: ' Cami Betancourt', interacciones: 3 },
    ...
    { mes: 'may', usuario: ' Cami Betancourt', interacciones: 75 },
    { mes: 'may', usuario: ' Laura Plazas', interacciones: 68 },
    { mes: 'may', usuario: ' Camilo Parada', interacciones: 66 },
    ...
    { mes: 'may', usuario: ' Yeny González', interacciones: 24 },
    ...
    { mes: 'may', usuario: ' Yenifer Casagua', interacciones: 7 },
    ...
    { mes: 'jun', usuario: ' Camilo Parada', interacciones: 110 },
    ...
    { mes: 'jun', usuario: ' Laura Plazas', interacciones: 95 },
    { mes: 'jun', usuario: ' Cami Betancourt', interacciones: 93 },
    { mes: 'jun', usuario: ' Yeny González', interacciones: 60 },
    ...
    { mes: 'jul', usuario: ' Camilo Parada', interacciones: 153 },
    { mes: 'jul', usuario: ' Lina Paola', interacciones: 130 },
    { mes: 'jul', usuario: ' Cami Betancourt', interacciones: 116 },
    ...
    { mes: 'jul', usuario: ' Laura Plazas', interacciones: 63 },
    { mes: 'jul', usuario: ' Camilo C Cubides', interacciones: 40 },
    { mes: 'jul', usuario: ' Yeny González', interacciones: 39 },
    ...
    { mes: 'jul', usuario: ' Yenifer Casagua', interacciones: 5 },
    ...
    { mes: 'ago', usuario: ' Camilo Parada', interacciones: 75 },
    ...
    { mes: 'ago', usuario: ' Cami Betancourt', interacciones: 49 },
    { mes: 'ago', usuario: ' Laura Plazas', interacciones: 38 },
    { mes: 'ago', usuario: ' Andrés', interacciones: 35 },
    { mes: 'ago', usuario: ' Yeny González', interacciones: 31 },
    ...
    { mes: 'ago', usuario: ' Yenifer Casagua', interacciones: 2 },
    { mes: 'ago', usuario: ' Ing Oscar Rodríguez', interacciones: 1 },
    { mes: 'sep', usuario: ' Laura Plazas', interacciones: 169 },
    { mes: 'sep', usuario: ' Camilo Parada', interacciones: 160 },
    ...
    { mes: 'sep', usuario: ' Cami Betancourt', interacciones: 51 },
    { mes: 'sep', usuario: ' Yeny González', interacciones: 44 },
    ...
    { mes: 'sep', usuario: ' Yenifer Casagua', interacciones: 7 },
